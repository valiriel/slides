...
output:
  xaringan::moon_reader:
    ...
    nature:
      ...
      slideNumberFormat: "Yacob Haddou _ ISEC 2022 _ %current%/%total%"
...
<img src="figures/ISEC_introductory.png"
alt=""
width="1050px"
/>
...
.right[
##<span style="color:#e71d36;font-size:120%">Extinction debts</span> and <span style="color:#1e90ff;font-size:120%">colonisation credits</span> <br> in United States breeding bird communities
]

----
<b><font size="5.5">Yacob Haddou, Jason Matthiopoulos, Sofie Spatharis, Rebecca Mancy, Davide Dominoni </font></b>

---
<!--- ending slide --->


<font size="6"> Haddou et al., <font/> <font size="4.5"> Widespread extinction debts and colonization
credits in United States breeding bird communities <font/><font size="6"> (2022) _Nature Ecology and Evolution_<font/>
<br> 

.left-column[

<img src="figures/paper_qr_code.png"
alt=""
width="300px"
/>
...
1<sup>st</sup> year PhD student @ University of Glasgow
...
> Quantify the contribution of past and present landscapes on current species diversity and predict <span style="color:crimson;font-size:100%">extinction debts</span> and  <span style="color:#1e90ff;font-size:100%">colonisation credits</span> at a continental scale.
...
- __Landscape __ over __15-years__ & across the __whole contiguous USA__
...
<br>
<span style="font-size:140%">__Past landscapes need to be considered and <span style="color:#e71d36;font-size:110%">debts</span> and <span style="color:dodgerblue;font-size:110%">credits</span> accounted for.__</span>
